...
# from core.workers.media_tasks import process_media_upload  # Temporarily disabled - workers module needs to be created

router_media = APIRouter()

@router_media.post("/media/upload/process")
...
@router_media.post("/media/upload/direct")
...
@router_media.get("/media/download/{module}/{user_id}/{filename}")
